...
export default function ThemeSettings() {
  const [presentation, setPresentation] = React.useState<Presentation>({ versesPerSlide: 2 });
  const [theme, setTheme] = React.useState<Theme>({ fontSize: 48 });
    ...
    <div className="space-y-4 text-zinc-200">
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setPresentation((p) => ({ ...p, versesPerSlide: Number(e.target.value || 1) }))
          }
        />
        <button
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setTheme((t) => ({ ...t, fontSize: Number(e.target.value || 48) }))
          }
        />
        <button
          className="ml-2 px-3 py-1 rounded bg-zinc-700 hover:bg-zinc-600"
